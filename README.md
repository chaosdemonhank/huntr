# HÜNTR — Find. Fuck. Repeat.
  ...
  - **Block & Report** — Full safety controls
  - **See Who Viewed You** — Profile view history
  - **Referral Rewards** — Refer a friend, both get a free month of PLUS
  - **Zero Ads. Ever.**
  ...
  - **Location-based grid** sorted by distance, up to 2000km radius
  - **Real-time chat** with read receipts and unread counts
  - **Private photo albums** with per-user access request/grant system
  - **Kinks & tribes** — full interest tagging
  - **HIV status & safe sex** — honest profile fields, no judgment
  - **Online presence** — live status indicators
  - **Location privacy** — hide exact location, toggle age/distance display
  ...
  1. **Download the APK:** [Latest
  Release](https://github.com/chaosdemonhank/huntr/releases)
  ...
  **Zero tolerance** for:
  ...
  - HÜNTR does not conduct background checks
  ...
  We do **not guarantee anonymity or exact location privacy**, and you use
  location-based features at your own risk.
  ...
  **HonkyHankInc, its owner(s), developers, affiliates, and partners shall NOT be
  ...
  HÜNTR is an independent product and is not affiliated with, endorsed by, or
  connected to any other platform or brand.
